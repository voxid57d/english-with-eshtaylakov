...
export default function Login() {
   ...
   // NEW: toggle for legacy login methods
            ...
            <div className="w-full max-w-md space-y-8 p-8 rounded-2xl bg-slate-900 border border-slate-800 shadow-xl">
               ...
               <div className="space-y-3">
                  ...
                  <p className="text-[11px] text-center text-slate-400 leading-snug">
                     Telegram is the fastest way to sign in.{" "}
                     <span className="text-slate-500">
                        Different login methods create separate accounts.
                     </span>
                  </p>
