      ...
      return (
         <main className="min-h-screen flex flex-col items-center justify-center bg-slate-950 text-slate-100 px-4">
            ...
            <p className="text-slate-400 mb-6 text-center max-w-md">
               Thank you for supporting the project. You have full access to all
               premium decks and future updates.
            </p>
            <button
         ...
         <div className="max-w-4xl mx-auto py-8 space-y-8">
            ...
            <section className="space-y-4">
               ...
               <h1 className="text-3xl md:text-4xl font-bold">
                  Get access to all IELTS CDI Mock exams, Vocabulary decks and
                  more!
               </h1>
                  ...
                  <ul className="space-y-2 text-sm text-slate-200">
                     <li className="flex gap-2">
                        ...
                        <div>
                           ...
                           <p className="text-slate-400 text-xs">
                              All premium vocabulary decks open immediately for
                              unlimited practice.
                           </p>
                        </div>
                     </li>
                     <li className="flex gap-2">
                        ...
                        <div>
                           ...
                           <p className="text-slate-400 text-xs">
                              Future reading, listening, and MOCK practice sets
                              are released to Premium members first.
                           </p>
                        </div>
                     </li>
                     <li className="flex gap-2">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
               <div className="w-full max-w-md rounded-2xl bg-slate-950 border border-slate-800 p-5 md:p-6 space-y-4 shadow-xl relative">
                  ...
                  <p className="text-sm text-slate-300">
                     Send <span className="font-semibold">{PRICE_TEXT}</span> to
                     the card below, then share the receipt on Telegram.
                  </p>
                  ...
                  <div className="rounded-xl bg-amber-500/10 border border-amber-500/40 p-3 text-xs text-amber-100 space-y-1">
                     ...
                     <p>
                        We’ll activate your Premium access within a few minutes.
                     </p>
                  </div>
